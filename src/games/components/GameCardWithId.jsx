...
export const GameCardWithId = () => {
  ...
  const backgroundWallpaper = gameCardId && gameCardId.detail[0] && gameCardId.detail[0].resp.background;
                  ...
                  <div className="">
                    <div className="">
                      <p className="text-light">
                        <b>Lanzamiento:</b>{" "}
                        {gameCardId?.detail[0]?.resp.release_date?.date}
                      </p>
                      <p className="text-light">
                        <b>Desarrolladores:</b>{" "}
                        {gameCardId?.detail[0]?.resp.developers}
                      </p>
                    </div>
                    <img
                    ...
                    <div className="text-light mb-5">
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html: gameCardId?.detail[0]?.resp.short_description,
                        }}
                      ></p>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="text-light">
                      <p
                        dangerouslySetInnerHTML={{
                          __html:
                            gameCardId?.detail[0]?.resp.pc_requirements
                              ?.minimum,
                        }}
                      ></p>
                    </div>
